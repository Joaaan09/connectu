    ...
    const savePublication = async (e) => {
        ...
        if (data.status === "success") {
            ...
            if (fileInput.files[0]) {
                ...
                const fileRequest = await fetch(Global.url + "publication/upload/" + data.publicationStored._id, {
                    method: "POST",
                    body: formData,
                    headers: {
                        "Authorization": localStorage.getItem("token")
                ...
                const uploadData = await fileRequest.json();
            ...
            // ✅ Resetear SIEMPRE el formulario (imagen o no)
            ...
            <aside className="layout__aside">
                ...
                <div className="aside__container">
                    ...
                    <div className="aside__container-form">
                        ...
                        <strong className={`alert ${stored === "stored" ? "alert-success" : stored === "error" ? "alert-error" : ""}`}>
                            {stored === "stored"
                                ? "Tu publicación ha sido publicada correctamente"
                                : stored === "error"
                                    ? "La publicación no se ha podido publicar"
                                    : ""}
                        </strong>
